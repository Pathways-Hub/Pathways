...
function createBlueIconButtons(x, y) {
    ...
    for (let i = 0; i < 4; i++) {
        ...
        // Add functionality to the Bold button
        if (buttonIcons[i] === 'fas fa-bold') {
            button.addEventListener('click', function() {
                ...
                textarea.rows = 1;
                textarea.cols = 30;
                textarea.style.fontWeight = 'bold'; // Apply bold style directly to the textarea

                document.body.appendChild(textarea);
                textarea.focus();

                // Add event listeners for Enter and blur
        ...
        // Add functionality to the Italics button
        if (buttonIcons[i] === 'fas fa-italic') {
            button.addEventListener('click', function() {
                ...
                textarea.rows = 1;
                textarea.cols = 30;
                textarea.style.fontStyle = 'italic'; // Apply italics style directly to the textarea
        ...
        // Add functionality to the Underline button
        if (buttonIcons[i] === 'fas fa-underline') {
            button.addEventListener('click', function() {
                ...
                textarea.rows = 1;
                textarea.cols = 30;
                textarea.style.textDecoration = 'underline'; // Apply underline style directly to the textarea
        ...
        // Add functionality to the Bullet button
        if (buttonIcons[i] === 'fas fa-list-ul') {
            button.addEventListener('click', function() {
                ...
                textarea.rows = 1;
                textarea.cols = 30;
                textarea.setAttribute('data-is-bullet', 'true'); // Mark textarea for bullet points
